...
public class ServerRequests {
    ...
    public static final String SERVER_ADDRESS = "http://kalpnilanjan.esy.es/Hotel/";
        ...
        protected User doInBackground(Void... params) {
            ...
            try {
                ...
                if (jObject.length() != 0){
                    ...
                    returnedUser = new User(name,user.username, user.password, mobile, email, gender);
                }
